<template>
  <div class="min-h-screen flex flex-col items-center justify-center bg-gray-100">
    <header class="w-full py-4 bg-white shadow-md flex justify-between items-center px-8">
    ...
    <main class="flex flex-col items-center justify-center flex-grow px-8">
      <h1 class="text-3xl font-bold mb-4 text-center">Real time accessibility scanning and monitoring</h1>
      <p class="text-gray-700 mb-8 text-center">Scan your generated tag to learn if it meets conformance standards.</p>
      <div class="flex items-center w-full max-w-md bg-white p-2 rounded-lg shadow">
        <input type="text" placeholder="Paste tag"
          class="w-full p-3 border-0 rounded-l-lg focus:outline-none focus:ring-0 text-gray-600 h-12" />
        <button
          class="flex items-center bg-purple-500 text-white text-sm py-3 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 max-w-full w-[80%]">
          <svg class="h-5 w-5 mr-1 flex-shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
