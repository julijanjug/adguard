	...
	<div class="min-h-screen flex flex-col items-center justify-center">
		...
		<main class="flex flex-col items-center justify-center flex-grow px-8 py-12">
			...
			<div class="w-full max-w-3xl mt-6 relative">
				...
				<div v-if="scanInProgress" class="absolute inset-0 flex items-center justify-center">
					<div class="text-center">
						<svg class=" h-10 w-10 text-purple-500 mx-auto mb-4" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<div class="w-full max-w-3xl flex justify-between items-center mt-2">
				<CustomDropdown :value="selectedOption" @option-selected="handleOptionSelected" :disabled="scanInProgress"></CustomDropdown>
